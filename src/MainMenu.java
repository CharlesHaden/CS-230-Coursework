...
public  class MainMenu {
	...
	public static void saveBoard() {
		try {
			...
			File SavedBoard = new File ("src/SavedBoard.txt");
	...
	public static void loadBoard() {
		...
		try {
			File file = new File ("src/SavedBoard.txt");
			Scanner inputFromFile = new Scanner (file);
			while (inputFromFile.hasNextLine()) {
				Scanner inputFromLine = new Scanner (inputFromFile.nextLine());
				curLine = inputFromLine.nextLine();
	...
	public static void saveProfile() {
		...
		try {
			// safely creating the files
			File SavedProfiles = new File ("src/SavedProfiles.txt");
	...
	public static String[] displayLeaderBoard() {
		...
		for (int i = 0; i < curProfileList.size(); i++) {
			printToScreen[i] = (curProfileList.get(i).getName() + ":" + curProfileList.get(i).getAllWins()[BoardNum] + ":" + curProfileList.get(i).getAllLosses()[BoardNum] + "\n");
		}
