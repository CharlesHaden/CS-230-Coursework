...
public  class MainMenu {
	 ...
	 * 
	 * @param fileName The string that provides the name of the saved file.
	 */
	 ...
	 * 
	 * @param curLine Is the current line for passed and turned into a Player object
	 * @return Player object created from the text passes as a parameter.
	 */
	...
	/**
	 * Reads individual lines from the profile txt file.
	 *
